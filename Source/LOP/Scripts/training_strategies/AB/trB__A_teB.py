...
class TS_trB__A_teB(object):
	...
	def __build_folds(self, total_number_folds, temporal_order, train_batch_size, long_range_pred, num_max_contiguous_blocks, embedded_piano_bool, mask_orch_bool):
		...
		tv_names_shuffle_A = self.sort_and_shuffle_dict(tv_dict_A)
		t_names_shuffle_B = self.sort_and_shuffle_dict(t_dict_B)
		tvt_names_shuffle_B = self.sort_and_shuffle_dict(tvt_dict_B)
		...
		for current_fold_number in range(total_number_folds):
			...
			one_fold_B, this_train_names_B, this_valid_names_B, this_test_names_B = build_one_fold(current_fold_number, total_number_folds, 
				t_dict_B, {}, tvt_dict_B, 
				t_names_shuffle_B, [], tvt_names_shuffle_B,
			...
			one_fold_A, this_train_names_A, this_valid_names_A, this_test_names_A = build_one_fold(current_fold_number, total_number_folds, 
				t_dict_A, tv_dict_A, {}, 
				t_names_shuffle_A, tv_names_shuffle_A, [],
				temporal_order, train_batch_size, long_range_pred, 
				num_max_contiguous_blocks, embedded_piano_bool, mask_orch_bool, self.random_inst)
