...
class TS_trA_teB(Training_strategy):
	...
	def get_folds(self, parameters, model_params):
		...
		if self.num_k_folds == 0:
			...
			K_folds_A, train_names_A, valid_names_A, _ = self.__build_folds(10, model_params["temporal_order"], parameters["batch_size"], parameters["long_range"], 
				parameters["num_max_contiguous_blocks"], parameters["embedded_piano"], parameters["mask_orch"], "A")
			K_folds_B, _, _, test_names_B = self.__build_folds(10, model_params["temporal_order"], parameters["batch_size"], parameters["long_range"], 
				parameters["num_max_contiguous_blocks"], parameters["embedded_piano"], parameters["mask_orch"], "B")
			...
			K_folds_A, train_names_A, valid_names_A, _ = self.__build_folds(self.num_k_folds, model_params["temporal_order"], parameters["batch_size"], parameters["long_range"], 
				parameters["num_max_contiguous_blocks"], parameters["embedded_piano"], parameters["mask_orch"], "A")
			K_folds_B, _, _, test_names_B = self.__build_folds(self.num_k_folds, model_params["temporal_order"], parameters["batch_size"], parameters["long_range"], 
				parameters["num_max_contiguous_blocks"], parameters["embedded_piano"], parameters["mask_orch"], "B")
			K_folds = self.__merge_folds(K_folds_A, K_folds_B)
