...
def train_wrapper(parameters, model_params,
	...
	# plt.clf()
	# plt.imshow(num_coOcc_piano_ALL)
...
def generate_wrapper(config_folder_fold, track_paths_generation, logger):
	for score_source in track_paths_generation:
			...
			forward.generate_midi(config_folder_fold, score_source, save_folder, initialization_type="zeros", number_of_version=3, duration_gen=100, logger_generate=logger)
	return
