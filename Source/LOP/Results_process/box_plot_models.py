...
# (name, path)
models = {
	"full_A": "/Users/leo/Recherche/lop/LOP/Experiments/Training_strategies/Beethov_liszt/full_A",
	"trB__A_teA": "/Users/leo/Recherche/lop/LOP/Experiments/Training_strategies/Beethov_liszt/trAB_teA",
	# "trB__A_teA": "/Users/leo/Recherche/lop/LOP/Experiments/Training_strategies/Beethov_liszt/trB__A_teA",
	"trC__B__A_teA": "/Users/leo/Recherche/lop/LOP/Experiments/Training_strategies/Beethov_liszt/trC__B__A_teA",
}

data = collections.OrderedDict()
for model_name in ["full_A", "trB__A_teA", "trC__B__A_teA"]:
# for model_name in ["duration", "no_duration"]:
	...
	with open(csv_file, 'r') as ff:
		...
		for row in reader:
			these_points.append(-float(row["short_range"]))
	data[model_name] = these_points
plt.boxplot(data.values(), labels=data.keys())
plt.xlabel('Schedule')
plt.ylabel('Accuracy')
#plt.title('Performances of the same architecture\n with or without the duration information')
plt.title('Different training schedules')
plt.show()
