...
def train_wrapper(parameters, model_params,
	...
	valid_tabs, test_score, best_epoch, valid_tabs_sampled, test_score_sampled, best_epoch_sampled, valid_tabs_LR, test_score_LR, best_epoch_LR =\
...
def generate_wrapper(config_folder_fold, track_paths_generation, logger):
	for score_source in track_paths_generation:
			generate_midi(config_folder_fold, score_source, number_of_version=3, duration_gen=100, logger_generate=logger)
	return
