...
def load_from_pair(tracks_path, quantization, binarize_piano, binarize_orch, temporal_granularity, align_bool):
    ...
    ############################################################
    pr_piano, event_piano, duration_piano, name_piano, pr_orch, _, instru_orch, _, duration =\
...
def init_with_seed(pr_orch, batch_size, seed_size, N_orchestra, instru_orch, instru_mapping):
